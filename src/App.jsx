    ...
    <div style={{background:C.bg,minHeight:"100vh"}}>
      ...
      <div style={{padding:".5rem 1rem .5rem",display:"flex",flexDirection:"column",gap:".6rem",borderBottom:`1px solid ${C.border}`}}>
        <div style={{display:"flex",gap:".5rem",alignItems:"center"}}>
          <button onClick={()=>setSortBy(v=>v==="alpha"?"match-desc":v==="match-desc"?"match-asc":"alpha")}
            style={{...s.btnSm(sortBy!=="alpha"?C.gold:C.surf2),fontSize:".75rem",fontWeight:sortBy!=="alpha"?700:500,color:sortBy!=="alpha"?"#000":C.text}}>
            {sortBy==="alpha"?"🔤 A→Z":sortBy==="match-desc"?"🔄 Maior match ↓":"🔄 Menor match ↑"}
          </button>
          <span style={{fontSize:".72rem",color:C.muted}}>
            {sortBy==="alpha"?"Ordem alfabética":sortBy==="match-desc"?"Do maior para o menor match":"Do menor para o maior match"}
          </span>
        </div>
        {/* Só com matches */}
