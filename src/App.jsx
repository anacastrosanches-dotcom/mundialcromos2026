...
export default function App() {
  const [screen, setScreen]           = useState("auth"); // auth | mode | grid | search | group | match | market | events | safety | editprofile | resetpassword
...
function Search({members, me, onBack}) {
  ...
  return (
    <div style={{background:C.bg,minHeight:"100vh"}}>
      ...
      {results.map(({sec,i,r,name,hasRepeat,needsIt})=>(
