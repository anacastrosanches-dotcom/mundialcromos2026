...
export default function App() {
  const [screen, setScreen]           = useState("auth"); // auth | mode | grid | search | group | match | market | events | safety | editprofile | sharelist
  ...
  useEffect(() => {
    ...
    // Só ouve SIGNED_IN e SIGNED_OUT — ignora TOKEN_REFRESHED etc.
