            ...
            <div style={{display:"flex",flexDirection:"column",gap:".6rem",marginBottom:"1.25rem"}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:".75rem",padding:".7rem",background:C.surf2,borderRadius:10,border:`1px solid ${C.border2}`}}>
                ...
                <div>
                  ...
                  <div style={{fontSize:".75rem",color:C.muted,lineHeight:1.4}}>Tens a mais para troca! Usa o botão + para indicar quantos tens.</div>
                </div>
              </div>
              <div style={{display:"flex",alignItems:"center",gap:".75rem",padding:".7rem",background:C.surf2,borderRadius:10,border:`1px solid ${C.border2}`}}>
                <div style={{width:36,height:44,background:C.surf3,border:`2px solid ${C.border2}`,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,fontSize:"1.2rem"}}>🖱️</div>
                <div>
                  <div style={{fontWeight:700,fontSize:".82rem",color:C.muted}}>Clique direito — Em falta</div>
                  <div style={{fontSize:".75rem",color:C.muted,lineHeight:1.4}}>Em qualquer estado, volta sempre a Em falta</div>
                </div>
              </div>
            </div>
